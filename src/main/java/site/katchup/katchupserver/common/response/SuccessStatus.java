...
public enum SuccessStatus {
     ...
     * category
     */
    CREATE_CATEGORY_NAME_SUCCESS(HttpStatus.CREATED, "업무 대분류명 추가 성공"),
    ...
    CREATE_FOLDER_NAME_SUCCESS(HttpStatus.CREATED, "업무 중분류명 추가 성공"),
     ...
     * card
     */
    CREATE_CARD_SUCCESS(HttpStatus.CREATED, "업무 카드 추가 성공"),
